...
class RepositoryTest {
    ...
    private Author author1 = new Author(1, "Igor");
    private Author author2 = new Author(2, "Egor");
    private Author author3 = new Author(3, "Boris");
    private Author author4 = new Author(4, "Masha");
    private Author author5 = new Author(5, "Katya");
